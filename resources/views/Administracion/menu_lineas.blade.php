							...
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									<div class="icon mt-2 mr-3 d-flex justify-content-center align-items-center">
										<a href="{{route('general_results',[$id])}}" class="hvr-grow">
											<span class="flaticon-reading"></span>
										</a>
									</div>
									<div class="text">
										<h3>Analizar Resultados</h3>
										<p>Analizar mediante uan grafica los datos obtenido de las boletas por competencia.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									<div class="icon mt-2 mr-3 d-flex justify-content-center align-items-center">
										<a href="{{route('listado',[$id])}}" class="hvr-grow">
