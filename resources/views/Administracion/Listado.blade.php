      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="{{route('HOME')}}">Home <i class="ion-ios-arrow-forward"></i></a></span><span class="mr-2"><a href="{{route('HOME')}}">Administradores <i class="ion-ios-arrow-forward"></i></a></span><span class="mr-2"><a href="{{route('lines')}}"> Listado de Encuestas<i class="ion-ios-arrow-forward"></i></a></span> <span> Competencias</span></p>
          </div>
        </div>
      </div>
    </section>
			...
			<div class="container">
				<div class="row">
	          	...
	          	<h2 class="mb-4">Procesos &amp; Operaciones</h2>
							<p>En esta pagina se muestra el listado de competencias de la <b><i>Linea Base</i></b> seleccionada.<br/><b>Operaciones.</b>En esta opcion se encuentran las herramientas necesarias para poder realizar la gestion y administracion de las competencias, con sus boletas, temas y graficas.<br/><b>Eliminar</b>, al dar clic en esta opcion se eliminara toda la informacion relacionada con este <br/>Sin mas que decir, me despido.</p>
							<button onclick="Add_Signature()" class="btn" style="background-color: #91cdff; color: white;">Agregar Competencias</button>
						</div>
					</div>
					<div class="col-md-7 wrap-about py-5 pr-md-4 ftco-animate">
						...
						<div class="row mt-5">
							@if (count($Encuestas) == 0)
							    <p></p>
								<h3 class="mb-4">No hay ninguna competencia en la linea base</h3>
							@else
							  ...
							  <tbody>
							  	@foreach($Encuestas as $P)
								      ...
								      <td>{{$P->Descripcion}}</td>
								      <td><a href="{{route('ops',[$P->id])}}" class="btn btn-secondary">Operaciones</td>
								  				...
								  				var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
									                $.ajax({
												          ...
												          success: function(response)
												          {
																...
																window.location.href = '{{ route('listado',[$id])}}';
												          }
												        });
									            }
									        })
