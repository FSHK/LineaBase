      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Educadores</span></p>
          </div>
        </div>
      </div>
    </section>
					...
					<div class="col-md-7 wrap-about py-5 pr-md-4 ftco-animate">
						...
						<div class="row mt-5">
							...
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									<div class="icon mt-2 mr-3 d-flex justify-content-center align-items-center">
										<a href="/Docentes_Mod" class="hvr-grow">
									...
									<div class="text">
										...
										<p>Ingrese Datos de los estudiantes que haran uso de la linea base.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
